...
class TestSpanCreation(unittest.TestCase):
    ...
    def test_start_span_explicit(self):
        ...
        other_parent = trace_api.SpanContext(
            trace_id=0x000000000000000000000000DEADBEEF, span_id=0x00000000DEADBEF0
        )
        ...
        with tracer.start_span("root") as root:
            ...
            with tracer.start_span("stepchild", other_parent) as child:
                ...
                self.assertEqual(other_parent.trace_state, child_context.trace_state)
                self.assertEqual(
    ...
    def test_span_members(self):
        ...
        with tracer.start_span("root") as root:
            ...
            root.set_attribute("http.url", "https://example.com:779/path/12/?q=d#123")
            ...
            self.assertEqual(
                root.attributes["http.url"], "https://example.com:779/path/12/?q=d#123"
            )
            ...
            self.assertEqual(root.events[0], trace.Event(name="event0", attributes={}))
            self.assertEqual(
                root.events[1],
